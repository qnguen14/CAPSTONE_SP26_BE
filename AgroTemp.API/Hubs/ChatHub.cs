...
public class ChatHub : Hub
{
    ...
    public ChatHub(IChatService chatService, IUserPresenceService presenceService, ILogger<ChatHub> logger)
    {
    ...
    public override async Task OnConnectedAsync()
    {
        ...
        if (userId != null)
        {
            var isFirstConnection = await _presenceService.UserConnectedAsync(userId, Context.ConnectionId);
    ...
    public override async Task OnDisconnectedAsync(Exception? exception)
    {
        ...
        if (userId != null)
        {
            var isLastConnection = await _presenceService.UserDisconnectedAsync(userId, Context.ConnectionId);
            if (isLastConnection)
            {
